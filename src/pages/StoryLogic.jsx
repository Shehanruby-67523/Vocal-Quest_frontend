...
export default function StoryLogic() {
  ...
  return (
    <div className="flex min-h-screen bg-[#070b13] text-slate-200 font-sans antialiased select-none overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        {/* HEADER */}
        <header className="h-[65px] bg-[#0a0f1d]/80 backdrop-blur-md border-b border-slate-800 flex items-center justify-between px-6 sticky top-0 z-50 shrink-0">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 relative overflow-hidden flex flex-col">
            ...
            <main 
              ...
              className="flex-1 bg-[#070b13] relative overflow-auto cursor-crosshair select-none [scrollbar-width:thin] [scrollbar-color:#FFD700_#0a0f1d]"
            >
                    ...
                    return (
                      <g key={idx}>
                        <path
                          ...
                          strokeWidth="3.5"
                          fill="none"
                          markerEnd="url(#yellow-arrow-sl-pages)"
            ...
            {/* Fixed Floating Bottom Legend Banner */}
          ...
          <aside className="w-80 bg-[#0a0f1d] border-l border-slate-800 p-6 flex flex-col justify-between shrink-0 select-none overflow-y-auto space-y-6">
