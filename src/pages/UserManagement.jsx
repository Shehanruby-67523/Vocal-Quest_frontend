...
export default function UserManagement() {
  ...
  return (
    <div className="min-h-screen bg-[#030e1d] text-slate-100 font-sans antialiased pb-12">
      
      {/* 1. TOP HEADER / NAVIGATION */}
      <header className="border-b border-slate-800/80 bg-[#041226]/80 backdrop-blur-md sticky top-0 z-40">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gold-400 text-slate-950 font-black shadow-[0_0_15px_rgba(217,183,79,0.3)]">
              {/* Overlapping loop vector */}
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
              </svg>
            </div>
            <span className="text-xl font-bold tracking-tight text-white flex items-center gap-1.5">
              Vocal Quest <span className="text-slate-400 font-normal text-sm border-l border-slate-700 pl-2">Admin</span>
            </span>
          </div>
